...
cola.metric(label='', value =f'{ont}', label_visibility='hidden')
colb.metric(label='', value =f'{onat}', label_visibility='hidden')
colc.metric(label='', value =f'{onmi}', label_visibility='hidden')
cold.metric(label='', value = f'{perc}', label_visibility='hidden')
wik = week -2 
